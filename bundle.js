...
exports.default = _backbone2.default.Collection.extend({
    ...
    initialize: function initialize() {
        ...
        var hasRootProp = options.hasOwnProperty('rootProp');
        var hasUrl = options.hasOwnProperty('url');
...
exports.default = _collection2.default.extend({
    ...
    parse: function parse(response) {
        response = _collection2.default.prototype.parse.call(this, response);
...
exports.default = _backbone4.default.CollectionView.extend({
    ...
    initialize: function initialize(options) {
        var hasArticles = options.hasOwnProperty('articles');
    ...
    checkCoauthors: function checkCoauthors(model) {
        this.children.each(function (authorView) {
...
exports.default = _backbone2.default.Model.extend({
    authors: new _collection2.default([], { rootProp: 'AuthorList' }), //Class-wide collection of unique authors
...
exports.default = _backbone2.default.Model.extend({
    ...
    changeArticlesAttr: function changeArticlesAttr(articleCID) {
    ...
    getSharedArticles: function getSharedArticles(authorCID) {
        var ownArticles = this.get('Articles');
        var author = this.collection._byId[authorCID];

        if (authorCID == this.cid) {
            return ownArticles;
        } else {
            return _underscore2.default.intersection(ownArticles, author.get('Articles'));
        }
    }
});
...
exports.default = _backbone4.default.View.extend({
    ...
    templateContext: function templateContext() {
        ...
        return {
            ...
            sharedNum: function sharedNum(author) {
    ...
    //provided.
    checkCoauthor: function checkCoauthor(articleCID) {
...
exports.default = _collection2.default.extend({
    ...
    changeArticles: function changeArticles(authorCIDs, articleCID) {
        var _this = this;

        authorCIDs.forEach(function (authorCID) {
            _this._byId[authorCID].changeArticlesAttr(articleCID);
        });
    },
    ...
    modelId: function modelId(attributes) {
        var id = _collection2.default.prototype.modelId.call(this, attributes);
    ...
    getBase64: function getBase64(attributes) {
        var message = _underscore2.default.values(attributes).join();
